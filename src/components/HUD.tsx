      ...
      <div className="flex justify-between items-start pointer-events-auto">
        ...
        <div className="flex gap-4">
          {isConfirmingReset ? (
            <div className="flex gap-2">
              <button 
                ...
                className="font-mono font-bold px-4 py-2 rounded-sm transition-colors uppercase tracking-widest bg-red-600 hover:bg-red-500 text-black border border-red-500/30 text-xs focus-visible:ring-2 focus-visible:ring-red-400 focus-visible:outline-none"
              >
                Confirm Reset
              </button>
              <button 
                onClick={() => setIsConfirmingReset(false)}
                className="font-mono font-bold px-4 py-2 rounded-sm transition-colors uppercase tracking-widest bg-gray-800 hover:bg-gray-700 text-gray-300 border border-gray-500/30 text-xs focus-visible:ring-2 focus-visible:ring-gray-400 focus-visible:outline-none"
              >
                Cancel
              </button>
            </div>
            ...
            <button 
              ...
              className="font-mono font-bold px-4 py-2 rounded-sm transition-colors uppercase tracking-widest bg-red-900/50 hover:bg-red-800 text-red-200 border border-red-500/30 text-xs focus-visible:ring-2 focus-visible:ring-red-400 focus-visible:outline-none"
            >
              Reset Sim
            </button>
          )}
          <button 
            onClick={onEndTurn}
            disabled={!isMyTurn}
            title={!isMyTurn ? "Wait for enemy turn to finish" : undefined}
            className={`font-mono font-bold px-6 py-2 rounded-sm transition-colors uppercase tracking-widest focus-visible:ring-2 focus-visible:ring-emerald-400 focus-visible:outline-none ${
              isMyTurn 
