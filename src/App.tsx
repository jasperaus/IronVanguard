...
import { onSnapshot, doc, collection, updateDoc, writeBatch, setDoc, getDoc } from "firebase/firestore";
            ...
            if (isDestroyed) {
              ...
              if (remainingPlayerMechs.length === 0) {
                ...
                try {
                  ...
                  handleFirestoreError(err, OperationType.UPDATE, `games/${gameState.id}`);
                }
